...
type BaseModel struct {
	...
	EnabledStatus *int8       `gorm:"column:enabled_status;default:1" json:"-"`
	Created       xtime.Time  `gorm:"column:created;type:timestamp;default:CURRENT_TIMESTAMP" json:"created"`
